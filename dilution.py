def c1(V1, C2, V2):
    ...
    if unit == 'M/ml':  # convert units if needed (standard unit is Mol/Liter)
        ...
        V1 = V1 * 1000
    C1 = (C2 * V2)/V1
    return f'The initial concentration is: {round(C1,rounding)} {unit}'
...
def v1(C1, C2, V2):
    ...
    if unit == 'ml':  # convert units if needed (standard unit is Liters)
        ...
        V2 = V2 * 1000
    V1 = (C2 * V2)/C1
    return f'The initial volume is: {round(V1,rounding)} {unit}'
...
def c2(C1, V1, V2):
    ...
    if unit == 'M/ml': # convert units if needed (standard unit is Mol/Liter)
        ...
        V1 = V1 * 1000
    C2 = (C1 * V1)/V2
    return f'The final concentration is: {round(C2,rounding)} {unit}'
...
def v2(C1, V1, C2):
    ...
    if unit == 'ml': #  
        ...
        V1 = V1 * 1000
    V2 = (C1 * V1)/C2
    return f'The final volume is: {round(V2,rounding)} {unit}'
